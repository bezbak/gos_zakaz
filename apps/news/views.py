...
def index(request):
    slider_news = News.objects.all().reverse()[:2]
    month_news = News.objects.all().reverse()[3:7]
    all_news = News.objects.all().reverse()[:20]
    slider2_news = News.objects.all().reverse()[:12]
